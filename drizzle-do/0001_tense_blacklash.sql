...
CREATE TABLE `__new_coordinator_state` (
	...
	`storage_limit_bytes` integer DEFAULT 100000000 NOT NULL,
...
INSERT INTO `__new_coordinator_state`("id", "vault_id", "current_cursor", "storage_used_bytes", "storage_limit_bytes", "health_summary_dirty", "last_commit_at", "last_activity_at", "last_gc_at", "last_health_flushed_at", "health_flush_retry_count", "last_health_flush_error", "last_health_flush_error_at") SELECT "id", "vault_id", "current_cursor", "storage_used_bytes", "storage_limit_bytes", "health_summary_dirty", "last_commit_at", "last_activity_at", "last_gc_at", "last_health_flushed_at", "health_flush_retry_count", "last_health_flush_error", "last_health_flush_error_at" FROM `coordinator_state`;--> statement-breakpoint
